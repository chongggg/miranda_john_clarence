            ...
            <div class="flex justify-between h-16">
                <div class="flex items-center space-x-3">
                    ...
                    <div class="hidden md:flex space-x-6 ml-8">
                        ...
                        <span class="text-blue-400 font-medium">ADD STUDENT</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="pt-24 pb-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            <!-- Header Section -->
                ...
                <p class="text-gray-300 text-lg">Register a new student in the system</p>
            </div>
            ...
            <div class="glassmorphism rounded-2xl shadow-xl overflow-hidden fade-in">
                <div class="px-8 py-6 border-b border-white/10">
                    ...
                    <p class="text-gray-300 mt-1">Enter the details for the new student</p>
                </div>
